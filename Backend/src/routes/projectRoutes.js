...
//     // Attach taskCount to each project in the response
...
// // GET  /api/projects/my       → Projects where logged-in employee is a member
...
//     // Employees can only view projects they're members of
...
//         t.assignedTo.some(u => u._id.toString() === req.user._id.toString())
//       );
//     }
...
// router.post('/:projectId/tasks', protect, adminOnly, async (req, res) => {
//   try {
...
// // PUT  /api/projects/:projectId/tasks/:taskId  → Edit task (admin only)
// router.put('/:projectId/tasks/:taskId', protect, adminOnly, async (req, res) => {
//   try {
...
// // PATCH /api/projects/:projectId/tasks/:taskId/status  → Employee updates their task status
// router.patch('/:projectId/tasks/:taskId/status', protect, async (req, res) => {
//   try {
...
// router.delete('/:projectId/tasks/:taskId', protect, adminOnly, async (req, res) => {
//   try {
//     const project = await Project.findById(req.params.projectId);
//     if (!project) return res.status(404).json({ message: 'Project not found' });
